...
allSections.push(new Section("Math 2",30,allTeachers[2]));
allSections.push(new Section("Math 3",25, allTeachers[3]));
allSections.push(new Section("US History",30,allTeachers[4]));
allSections.push(new Section("CS",32,allTeachers[3]));
allSections.push(new Section("English",30,allTeachers[1]));
